...
class ConferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conference" do
    assert_difference('Conference.count') do
      post conferences_url, params: { conference: { bankpath: @conference.bankpath, description: @conference.description, password: @conference.password, zip: @conference.zip } }
    end
  ...
  test "should update conference" do
    patch conference_url(@conference), params: { conference: { bankpath: @conference.bankpath, description: @conference.description, password: @conference.password, zip: @conference.zip } }
